...
interface QueryGenModelSelectProps {
    open: boolean;
...
export const QueryGenModelSelect: React.FC<QueryGenModelSelectProps> = ({ open, onClose, onSave }) => {
    const [selectedModelIdx, setSelectedModelIdx] = useState<number>(0);
    const models: ModelInfo[] = INFO.QUERY_GENERATION;
